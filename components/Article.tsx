        ...
        <>
          ...
          <div className="px-1">
            ...
            <Link href={`/${article?.slug}`}>
              <h1 className="text-[1.8rem] lg:text-3xl text-neutral-300 hover:text-primary hover:underline hover:underline-offset-2 transition-all font-bold cursor-pointer leading-tight lg:leading-snug mt-2">
                {article?.title}
              </h1>
            </Link>
            ...
            <h4 className="text-xs font-medium text-neutral-500 mt-1 lg:mt-2">
              ...
              (article?.content?.text &&
                article?.content?.text?.length > 100) ? (
                <>
